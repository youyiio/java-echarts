...
public class Label implements Serializable {
    ...
    private String position; // Default: 'outside'
    
    private Object formatter; //string|Function
    
    private Object rotate; //boolean|number
    ...
    private String alignTo; // Default: 'none'
    
    private Object edgeDistance; //string|number Default: '25%'
    
    private String bleedMargin; // Default: 10
    
    private String distanceToLabelLine; // Default: 5
