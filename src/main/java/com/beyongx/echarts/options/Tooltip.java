...
public class Tooltip implements Serializable {
    ...
    private String showContent; // Default: true
    
    private String alwaysShowContent; // Default: false
    
    private String triggerOn; // Default: 'mousemove|click'
    
    private String showDelay; // Default: 0
    
    private String hideDelay; // Default: 100
    
    private String enterable; // Default: false
    
    private String renderMode; // Default: 'html'
    
    private String confine; // Default: false
    
    private String appendToBody; // Default: false
    
    private String className; //
    
    private String transitionDuration; // Default: '0.4'
    ...
    private String order; // Default: 'seriesAsc'
