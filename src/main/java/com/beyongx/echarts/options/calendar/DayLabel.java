...
package com.beyongx.echarts.options.calendar;
...
public class DayLabel implements Serializable {
    ...
    private String firstDay; // Default: 0
    
    private String margin; // Default: 0
    
    private String position; // Default: 'start'
    
    private Object nameMap; //string|Array Default: 'en'
    ...
    public DayLabel(Map<String, Object> property)
    {
    }
}