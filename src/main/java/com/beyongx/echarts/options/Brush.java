...
public class Brush implements Serializable {
    ...
    private Object seriesIndex; //Array|number|string Default: 'all'
    
    private Object geoIndex; //Array|number|string
    
    private Object xAxisIndex; //Array|number|string
    
    private Object yAxisIndex; //Array|number|string
    
    private String brushType; // Default: 'rect'
    
    private String brushMode; // Default: 'single'
    
    private String transformable; // Default: true
    
    private Map<String, Object> brushStyle; //
    
    private String throttleType; // Default: 'fixRate'
    
    private String throttleDelay; // Default: 0
    
    private String removeOnClick; // Default: true
    
    private Map<String, Object> inBrush; //
    
    private Map<String, Object> outOfBrush; //
    
    private String z; // Default: 10000
